...
function step3() {
	...
	setStyleCss3(product1, 'animation', 'fadeIn 0.5s ease-in-out ' + (currentDuration + 0.5) + 's forwards');
	currentDuration += 1;

	setStyleCss3(product2, 'animation', 'fadeIn 0.5s ease-in-out ' + (currentDuration + 0.5) + 's forwards');
	currentDuration += 1;

	setStyleCss3(product3, 'animation', 'fadeIn 0.5s ease-in-out ' + (currentDuration + 0.5) + 's forwards');
	currentDuration += 1;
